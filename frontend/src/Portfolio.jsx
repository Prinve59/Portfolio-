...
export default function PortfolioHero() {
  ...
  return (
    <div className="h-[fit-content] bg-[#070b1a] text-white relative overflow-hidden ">
      ...
      {/* Navbar */}
      <nav className="sticky top-0 z-50 flex flex-col md:flex-row justify-between items-center px-4 md:px-[9vw] py-4 md:py-6 bg-[#070b1a]/70 backdrop-blur-lg border-b border-emerald-400/10 gap-4 md:gap-0">
      ...
      <section ref={heroRef} className={`relative z-10 grid md:grid-cols-2 gap-10 px-[9vw] py-14 items-center transition-all duration-700 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        {/* Right Avatar - First on mobile */}
        <div className="flex justify-center md:order-2">
          <div className="relative w-64 h-64 md:w-96 md:h-96">
            {/* Single orbit ring with 4 particles */}
            <div className="absolute inset-8 rounded-full border-2 border-emerald-400/40">
              <div className="absolute inset-0 animate-[spin_3s_linear_infinite]">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  <div className="w-6 h-1.5 bg-emerald-400 rounded-full blur-[1px]"></div>
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-1.5 bg-gradient-to-l from-emerald-400/60 via-emerald-400/20 to-transparent rounded-full blur-sm"></div>
                </div>
              </div>
              <div className="absolute inset-0 animate-[spin_5s_linear_infinite]">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  <div className="w-5 h-1.5 bg-emerald-300 rounded-full blur-[1px]"></div>
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-1.5 bg-gradient-to-l from-emerald-300/60 via-emerald-300/20 to-transparent rounded-full blur-sm"></div>
                </div>
              </div>
              <div className="absolute inset-0 animate-[spin_8s_linear_infinite]">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  <div className="w-5 h-1.5 bg-emerald-500 rounded-full blur-[1px]"></div>
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-1.5 bg-gradient-to-l from-emerald-500/60 via-emerald-500/20 to-transparent rounded-full blur-sm"></div>
                </div>
              </div>
              <div className="absolute inset-0 animate-[spin_12s_linear_infinite]">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  <div className="w-4 h-1 bg-emerald-200 rounded-full blur-[1px]"></div>
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-1 bg-gradient-to-l from-emerald-200/60 via-emerald-200/20 to-transparent rounded-full blur-sm"></div>
                </div>
              </div>
            </div>
...
">
          ...
          <div className="flex gap-4 mt-8 items-center">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://leetcode.com/prinve59" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center border border-emerald-400 rounded-full text-emerald-400 hover:bg-emerald-400 hover:text-black cursor-pointer transition">
